...
public class ResumeIngestionResponse extends IngestionUpdateStateResponse {
    ...
    public ResumeIngestionResponse(final boolean acknowledged, final boolean shardsAcknowledged, final IngestionStateShardFailure[] shardFailuresList, String errorMessage) {
