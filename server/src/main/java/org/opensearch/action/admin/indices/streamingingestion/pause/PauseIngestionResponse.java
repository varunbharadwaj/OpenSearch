...
public class PauseIngestionResponse extends IngestionUpdateStateResponse {
    ...
    public PauseIngestionResponse(final boolean acknowledged, final boolean shardsAcknowledged, final IngestionStateShardFailure[] shardFailuresList, String errorMessage) {
