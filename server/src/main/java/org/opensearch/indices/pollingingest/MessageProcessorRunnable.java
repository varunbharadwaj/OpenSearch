            ...
            try {
                ...
                switch (operation.operationType()) {
                    case INDEX:
                        ...
                        break;
                    case DELETE:
                        if (updateMessage.autoGeneratedIdTimestamp() == UNSET_AUTO_GENERATED_TIMESTAMP) {
                            engine.delete((Engine.Delete) operation);
                        } else {
                            logger.debug("Delete operation dropped since ID it not found");
                        }
                        break;
                    default:
            ...
            switch (opType) {
                case INDEX:
                    ...
                    operation = new Engine.Index(
                        ...
                        System.nanoTime(),
                        updateMessage.autoGeneratedIdTimestamp(),
                        false,
                        UNASSIGNED_SEQ_NO,
                        0
                    );
