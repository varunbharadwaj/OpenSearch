...
public class IngestionSourceTests extends OpenSearchTestCase {
    ...
    public void testConstructorAndGetters() {
        ...
        IngestionSource source = new IngestionSource("type", pointerInitReset, DROP, StreamPoller.State.POLLING, params);
    ...
    public void testEquals() {
        ...
        IngestionSource source1 = new IngestionSource("type", pointerInitReset, DROP, StreamPoller.State.POLLING, params1);

        Map<String, Object> params2 = new HashMap<>();
        params2.put("key", "value");
        IngestionSource source2 = new IngestionSource("type", pointerInitReset, DROP, StreamPoller.State.POLLING, params2);
        assertTrue(source1.equals(source2));
        assertTrue(source2.equals(source1));

        IngestionSource source3 = new IngestionSource("differentType", pointerInitReset, DROP, StreamPoller.State.POLLING, params1);
    ...
    public void testToString() {
        ...
        IngestionSource source = new IngestionSource("type", pointerInitReset, DROP, StreamPoller.State.POLLING, params);
        String expected =
            "IngestionSource{type='type',pointer_init_reset='PointerInitReset{type='REWIND_BY_OFFSET', value=1000}',error_strategy='DROP',poller_state='POLLING', params={key=value}}";
